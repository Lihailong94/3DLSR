...
if __name__ == '__main__':
    ...
    parser.add_argument('--images-dir', type=str, default='/home/lhl/Desktop/LHL/Datasets/BSD100/image_SRF_3/HR')
    parser.add_argument('--output-path', type=str, default='dataset/test/bsd100_test_x3.h5')
